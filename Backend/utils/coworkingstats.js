...
const updateEditedAverageRating = async (coWorkingId, reviewId, oldRating) => {
    ...
    newAverage = ( (stats.averageRating * stats.reviewCount) + (review.rating - oldRating) ) / stats.reviewCount;
...
module.exports = { createAverageRating , updateDeletedAverageRating, updateAddedAverageRating, updateEditedAverageRating};
