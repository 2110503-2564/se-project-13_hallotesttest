      ...
      {showBanPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md text-center border-4 border-red-200 relative animate-bounce-in">
            ...
            <span className="absolute top-2 right-4 text-red-400 text-2xl font-bold animate-pulse">
              !
            </span>
          </div>
          <style jsx>{`
      ...
      <section className="py-16 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-indigo-900 mb-12">
            Why Choose Our Co-Working Spaces
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Strategically located spaces in the heart of business districts
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                24/7 access to accommodate your work schedule and maximize
                productivity.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Regular networking events and workshops to help you grow your
                business.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-indigo-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-indigo-100 max-w-2xl mx-auto mb-8">
            Find the ideal workspace for your needs, whether it's a quiet desk,
            a collaborative area, or a professional meeting room.
          </p>
          <Link
            href="/booking"
            className="inline-block px-8 py-4 bg-white text-indigo-900 rounded-md font-semibold hover:bg-indigo-50 transition-colors duration-300 transform hover:scale-105"
          >
            Book Now
          </Link>
        </div>
